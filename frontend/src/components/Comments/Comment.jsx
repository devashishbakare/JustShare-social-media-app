...
export const Comment = ({ parentId, comment, userReplyingStatus }) => {
    ...
    try {
      if (postId === "-1") {
        ...
        if (deleteResponse.status === 200) {
          const prevReplyCount = replies.length;
          setReplies((prevReplies) =>
            prevReplies.filter(
              (eachReply) => eachReply._id !== deleteResponse.data
            )
          );
          setCommentReplyCount(prevReplyCount - 1);
      ...
      //   if (deleteResponse.status === 200) {
      //     //todo: call parent function or get the parentstate here to update and return
